...
import {v4} from "uuid";
import {AddTodoActionType, RemoveTodoActionType} from "../todoReducer/todolist-reducer";
...
type ActionsTypes = AddTaskType | RemoveTaskType | changeCheckBoxTaskType | changeTaskTitleType | AddTodoActionType | RemoveTodoActionType;
...
// AC's
export const removeTaskAC = (idForTodolist: string, taskId: string): RemoveTaskType => {
    return {
        type: "REMOVE-TASK",
        idForTodolist,
        taskId,
...
export const addTaskAC = (title: string, idForTodolist: string): AddTaskType => {
    return {
        type: "ADD-TASK",
        idForTodolist,
        title,
...
export const changeCheckBoxAC = (taskId: string, idForTodolist: string, isDone: boolean): changeCheckBoxTaskType => {
    return {
        type: "CHANGE-CHECKBOX",
        taskId,
        idForTodolist,
...
export const changeTaskTitleAC = (taskId: string, idForTodolist: string, newTitle: string): changeTaskTitleType => {
    return {
        type: "CHANGE-TASK-TITLE",
        taskId,
        idForTodolist,
